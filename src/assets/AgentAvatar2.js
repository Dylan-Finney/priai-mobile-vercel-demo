...
export function AgentAvatar2() {
  ...
  //     viewBox="0 0 60 57"
  //   >
  //     <g filter="url(#filter0_d_346_15585)">
  //       <rect
  //         width="48"
  //         height="48"
  //         x="4"
  ...
  //       <path
  //         fill="#107569"
  //         d="M45 48.12a3.288 3.288 0 01-1.44-.307 2.618 2.618 0 01-1.015-.853 2.25 2.25 0 01-.405-1.236h1.279c.03.375.197.684.498.925.301.242.662.362 1.082.362.336 0 .633-.076.891-.23a1.65 1.65 0 00.614-.643c.15-.273.226-.584.226-.933 0-.356-.077-.672-.23-.95a1.699 1.699 0 00-.636-.657 1.794 1.794 0 00-.92-.243c-.264 0-.53.046-.797.137a1.85 1.85 0 00-.648.357l-1.206-.178.49-4.398h4.799v1.129h-3.703l-.277 2.442h.05c.171-.165.397-.303.678-.414.285-.11.589-.166.912-.166a2.671 2.671 0 012.404 1.415c.241.435.36.935.358 1.5a2.916 2.916 0 01-.384 1.513c-.255.443-.61.792-1.065 1.048-.452.253-.97.38-1.556.38z"
  //       ></path>
  //       <rect
  //         width="25"
  //         height="19"
  ...
  //           result="effect1_dropShadow_346_15585"
  //         ></feBlend>
  //         <feBlend
  //           in="SourceGraphic"
  //           in2="effect1_dropShadow_346_15585"
  //           result="shape"
  //         ></feBlend>
  //       </filter>
  //       <pattern
  ...
  //       >
  //         <use transform="scale(.00313)" xlinkHref="#image0_346_15585"></use>
  //       </pattern>
  //       <image
  //         id="image0_346_15585"
  //         width="320"
